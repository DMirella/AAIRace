...
GameWindow::GameWindow() {
  ...
  auto draw_sprite_callback = std::bind(&GameWindow::DrawSprite, this, std::placeholders::_1);
  ...
  window_context.draw_function = draw_sprite_callback;
...
void GameWindow::DrawSprite(const sf::Sprite& sprite) {
  window_.draw(sprite);
}